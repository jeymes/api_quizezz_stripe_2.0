...
export const sendWelcomeEmail = async (email: string, name: string, password: string) => {
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px;">
      ...
      <a href="https://quizezz.com.br/signin" style="display: inline-block; margin: 10px 0; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">
        Acessar sistema
      </a>
